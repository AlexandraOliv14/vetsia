Rails.application.routes.draw do
  ...
  get 'tipo_atenciones/:id/editar',to: 'tipo_atenciones#editar', as: 'tipo_atencion_editar'
  delete 'tipo_atenciones/:id',to: 'tipo_atenciones#eliminar'
  ...
  get 'medicos/nuevo', to: 'medico#nuevo' , as: 'nuevo_medico'
  ...
  get 'bloques/nuevo', to: 'bloque#nuevo', as: 'nuevo_bloque'
  post 'bloques/', to: 'estado#crear'

  get 'estados/',to: 'estado#index', as: 'estados'
  get 'estados/nuevo',to: 'estado#nuevo' ,as: 'nuevo_estado'
  ...
  get 'tipo_mascotas/nuevo',to: 'tipo_mascota#nuevo' ,as: 'nuevo_tipo_mascota'
  ...
  get  'atenciones/nuevo',to: 'atenciones#nuevo', as: 'nuevo_atencion'
